...
if(success){button.innerHTML='<i data-lucide="check" style="color: #1dac52ff;"></i>';this.initIcons();setTimeout(()=>{button.innerHTML='<i data-lucide="copy"></i>';this.initIcons();},2000);}}catch(err){console.error('Failed to copy: ',err);}});});this.initIcons();}};})();(function(){function registerSlang(){if(typeof Prism==='undefined'){setTimeout(registerSlang,50);return;}
